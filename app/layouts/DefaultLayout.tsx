...
export default function DefaultLayout({ loaderData }: Route.ComponentProps) {
  return (
    <>
      ...
      <main className="md:flex h-[calc(100vh-2.5rem)] md:flex-col w-full items-center bg-[url(/booksBackgroundImage.jpg)] bg-cover bg-center bg-no-repeat md:h-screen">
        <Outlet />
      </main>
      <ToastContainer />
    </>
